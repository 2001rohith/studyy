                        ...
                        <div className='row text-dark pt-3 ms-3'>
                            ...
                            <div className='row'>
                                {Array.isArray(modules) && modules.map((mod, index) => (
                                    <div className='col-md-4 mb-4' key={mod._id}> {/* Adjust the col size as needed */}
                                        <div className='card text-dark bg-light'>
                                            <img src="/banner6.jpg" className="card-img-top" alt="..." style={{ height: '200px', objectFit: 'cover' }} />
