...
function TeacherLiveClassesCourses() {
    ...
    const handleView = (id) => {
        ...
        navigate("/teacher-view-classes", { state: { id } })
    }
                                    ...
                                    {Array.isArray(courses) && courses.map((course) => (
                                        <div className='col-md-4' key={course.id}>
                                            <div className='card assignment-course-card text-dark bg-light'>
                                                <img src="/banner11.jpg" className="card-img-top" alt="module image" style={{ height: '200px', objectFit: 'cover', borderRadius: "20px 20px 10px 10px" }} />
...
export default TeacherLiveClassesCourses
