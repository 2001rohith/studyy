                            ...
                            <tbody>
                                {currentUsers.map((user, index) => (
                                    <tr key={user._id}>
                                        ...
                                        <td>
                                            {/* <button className='btn table-button mx-1' onClick={() => handleEdit(user)}>Edit</button> */}
                                            <button className='btn table-button mx-1' onClick={() => { setShowDeleteModal(true); setSelectedUser(user) }}>Delete</button>
                                            <button className='btn table-button mx-1' onClick={() => { setShowBlockModal(true); setSelectedUser(user); setIsBlocking(user.isBlocked) }}>{user.isBlocked ? 'Unblock' : 'Block'}</button>
                                        </td>
                                    </tr>
                                ))}
                            </tbody>
