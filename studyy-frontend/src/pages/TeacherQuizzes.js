                            ...
                            <div className="modal-body" style={{ maxHeight: '400px', overflowY: 'auto' }}>
                                {submissions.length > 0 ? (
                                    <div className="container">
                                        {/* <div className="row fw-bold mb-3 border-bottom pb-2 text-center">
                                <div className="col">Name</div>
                                <div className="col">Score</div>
                                <div className="col">Submitted At</div>
                            </div> */}
                                        {submissions.map((submission, index) => (
                                            <div key={index} className="row align-items-center text-center mb-3 py-2 border-bottom">
                                                <div className="col">{submission.name}</div>
                                                <div className="col">Score: {submission.score}</div>
                                                <div className="col">{new Date(submission.submittedAt).toLocaleString()}</div>
                                            </div>
                                        ))}
                                    </div>
                                ) : (
