                            ...
                            >
                                {loading ? (
                                    ...
                                    <div className="container">
                                        {/* <div className="row text-center border-bottom fw-bold mb-2" style={{ gap: "5px" }}>
                                            <div className="col-4">Name</div>
                                            <div className="col-5">Time</div>
                                            <div className="col-3">Action</div>
                                        </div> */}
                                        {submissions.map((submission, index) => (
                                            <div key={index} className="row align-items-center border-bottom mb-3">
                                                <div className="col-4">{submission.name}</div>
                                                <div className="col-5">
                                                    {new Date(submission.submittedAt).toLocaleString()}
                                                </div>
                                                <div className="col-3">
                                                    <button className='btn table-button' onClick={() => handleViewPDF(submission)}>View</button>
                                                </div>
                                            </div>
                                        ))}
                                    </div>
